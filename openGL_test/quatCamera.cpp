...
/**
	...
	*/
quatCamera::quatCamera(float left, float right, float bottom, float top, float zNear, float zFar)
	: recalcViewMatrix(true),
	rotationHitCount(0)
{
	//recalcViewMatrix = true;
...
/**
	...
	*/
quatCamera::quatCamera(float fieldOfViewY, float aspectRatio, float zNear, float zFar)
	: recalcViewMatrix(true),
	rotationHitCount(0)
{
	//recalcViewMatrix = true;
...
//----------------------------------------------------------------------------------------
void quatCamera::initLocalCoordinateSystem() {
	l.x = -1.0f;
	l.y = 0.0f;
	l.z = 0.0f;
...
/**
	...
	* @param z
	*/
void quatCamera::setPosition(float x, float y, float z) {
	eyePosition.x = x;
	eyePosition.y = y;
	eyePosition.z = z;
...
/**
	...
	* @param v
	*/
void quatCamera::setPosition(const vec3 &v) {
...
/**
	...
	*/
vec3 quatCamera::getPosition() const {
	return eyePosition;
}
...
/**
	...
	*/
vec3 quatCamera::getLeftDirection() const {
	return l;
}
...
/**
	...
	*/
vec3 quatCamera::getUpDirection() const {
	return u;
}
...
/**
	...
	*/
vec3 quatCamera::getForwardDirection() const {
	return f;
}
...
/**
	...
	*/
quat quatCamera::getOrientation() const {
	return orientation;
}
...
/**
	...
	*/
mat4 quatCamera::getViewMatrix() const {
	if (recalcViewMatrix) {
...
//----------------------------------------------------------------------------------------
void quatCamera::normalizeCamera() {
	l = normalize(l);
	u = normalize(u);
	f = normalize(f);
...
//----------------------------------------------------------------------------------------
void quatCamera::registerRotation() {
	rotationHitCount++;
...
/**
	...
	* @param axis
	*/
void quatCamera::rotate(float angle, const vec3 & axis) {
...
/**
	...
	* @param z
	*/
void quatCamera::translate(float x, float y, float z) {
	eyePosition.x += x;
	eyePosition.y += y;
	eyePosition.z += z;
...
/**
	...
	* @param v
	*/
void quatCamera::translate(const vec3& v) {
...
/**
	...
	*/
void quatCamera::translateLocal(float left, float up, float forward) {
	eyePosition += left * l;
	eyePosition += up * u;
...
/**
	...
	* @param v
	*/
void quatCamera::translateLocal(const vec3 &v) {
	translateLocal(v.x, v.y, v.z);
}

//----------------------------------------------------------------------------------------
void quatCamera::lookAt(const vec3 & center) {
...
/*
	...
	*/
void quatCamera::lookAt(float centerX, float centerY, float centerZ) {
	// f = center - eye.
...
//----------------------------------------------------------------------------------------
void quatCamera::lookAt(const vec3 & eye, const vec3 & center, const vec3 & up) {
	eyePosition = eye;
